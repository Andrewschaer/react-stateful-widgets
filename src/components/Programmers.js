...
export default function Programmers() {
  ...
  const getNameOfFeatured = () => {
    ...
    let featuredProgrammer = programmersList.find(programmer => programmer.id === featuredProgrammerId)
  ...
  const style = {
    fontSize: '1.5em',
    marginTop: '0.5em',
    color: featuredProgrammerId === null ? 'royalblue': 'gold', // 🤔 color turns to gold, when celebrating
  };
